# simulation_setup_phase_2.py
"""
Enhanced dataset generation for Phase 2 New - Standalone Script

This script generates 50 training scenarios and 10 validation scenarios
with improved diversity for better ANC model training.

Usage:
    python simulation_setup_phase_2.py

Output:
    - data/train/: 50 training scenarios
    - data/val/: 10 validation scenarios
    - Metadata JSON files for reproducibility
"""
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("\nThis will REPLACE existing data with fresh 50 training + 10 validation scenarios")
    ...
    print("\nNext steps:")
    print("  1. Verify data: ls data/train/*_ref.wav | wc -l")
    print("  2. Train baseline: python -m phase_2_new.training.train --config baseline")
